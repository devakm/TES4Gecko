...
public final class SpellEffectType
{
	...
	private static Map<String, String> spellEffectNameMap;
	static
	{
		spellEffectNameMap = new HashMap<String, String>();
		// Spell Effect Name Data
	...
	{
		if (!spellEffectNameMap.containsKey(spellEffectID)) return "Unknown Spell Effect [" + spellEffectID + "]";
		else return spellEffectNameMap.get(spellEffectID); 
	}
